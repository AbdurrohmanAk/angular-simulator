...
export class AppComponent {
  ...
  private saveDateLastVisit(): void {
    ...
    this.storageService.setItem<string>('last-visit', currentDate);
  }

  private saveVisitCount(): void {
    const storedCount: number | null =
      this.storageService.getItem<number>('visit-count');
    let count: number = storedCount ?? 0;
    count = count + 1;
    this.storageService.setItem<number>('visit-count', count);
  }
